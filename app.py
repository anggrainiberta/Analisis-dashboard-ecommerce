...
with tab1:
    ...
    traffic_df = df_master.groupby('traffic_source')['sale_price'].mean().reset_index().sort_values('sale_price', ascending=False)
...
with tab3:
    ...
    # kolom yang benar: total_transaction, total_spent
...
with tab4:
    ...
    # kolom yang benar: total_revenue_kategori, dan hitung banyak_transaksi dari data
